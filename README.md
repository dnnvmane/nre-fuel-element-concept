...
The design is supported by **20 engineering diagrams** created in draw.io. For the best experience, these diagrams are **embedded directly within each relevant section** of the documentation. Sorry if the images are crooked 🥺.
